...
public class MatchmakingManager : MonoBehaviour
{
    ...
    void MatchmakingJoinRoomCallback(Message<Room> msg)
    {
        ...
        Debug.Log ("Match room joined: " + m_matchRoom + " count: " + msg.Data.Users.Count);
    ...
    void MatchmakingRoomUpdateCallback(Message<Room> msg)
    {
        ...
        Debug.LogFormat(
            ...
            "  User Count {2}\n" +
            "  Datastore Count {3}\n",
            msg.Data.ID, msg.Data.Owner.OculusID, msg.Data.Users.Count,msg.Data.DataStore.Count);
    ...
    private void ProcessRoomData(Room room)
    {
        ...
        // owner of the room.
        if (m_state == MatchRoomState.MyTurn && room.Owner.ID == PlatformManager.MyID)
        {
