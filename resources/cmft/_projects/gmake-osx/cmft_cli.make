...
ifeq ($(config),debug32)
  OBJDIR     = ../../_build/osx32_clang/obj/x32/Debug/cmft_cli
  ...
  INCLUDES  += -I../../dependency/bx/include/compat/osx -I../../dependency -I../../src/cmft -I../../src -I../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -g -m32 -m32 -Wfatal-errors -msse2 -Wunused-value -Wundef -stdlib=libc++
...
ifeq ($(config),release32)
  OBJDIR     = ../../_build/osx32_clang/obj/x32/Release/cmft_cli
  TARGETDIR  = ../../_build/osx32_clang/bin
  TARGET     = $(TARGETDIR)/cmftRelease
  DEFINES   += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS
  INCLUDES  += -I../../dependency/bx/include/compat/osx -I../../dependency -I../../src/cmft -I../../src -I../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -g -O3 -m32 -m32 -Wfatal-errors -msse2 -Wunused-value -Wundef -stdlib=libc++
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS) -fno-rtti -fno-exceptions
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -m32 -L/usr/lib32 -stdlib=libc++
  LDDEPS    +=
...
ifeq ($(config),debug64)
  OBJDIR     = ../../_build/osx64_clang/obj/x64/Debug/cmft_cli
  TARGETDIR  = ../../_build/osx64_clang/bin
  TARGET     = $(TARGETDIR)/cmftDebug
  DEFINES   += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS
  INCLUDES  += -I../../dependency/bx/include/compat/osx -I../../dependency -I../../src/cmft -I../../src -I../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -g -m64 -m64 -Wfatal-errors -msse2 -Wunused-value -Wundef -stdlib=libc++
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS) -fno-rtti -fno-exceptions
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release64)
  OBJDIR     = ../../_build/osx64_clang/obj/x64/Release/cmft_cli
  TARGETDIR  = ../../_build/osx64_clang/bin
  TARGET     = $(TARGETDIR)/cmftRelease
  DEFINES   += -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS
  INCLUDES  += -I../../dependency/bx/include/compat/osx -I../../dependency -I../../src/cmft -I../../src -I../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -g -O3 -m64 -m64 -Wfatal-errors -msse2 -Wunused-value -Wundef -stdlib=libc++
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS) -fno-rtti -fno-exceptions
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -m64 -L/usr/lib64 -stdlib=libc++
  LDDEPS    +=
